            ...
            <div class="card loginForm">
              <div class="row g-0">
                    ...
                    >
                      <div class="d-flex align-items-center mb-3 pb-1">
                        <div class="logo">
                          ...
                          <span class="titleWeb"
                            >T<span class="text-dark">BOOKSTORE</span></span
                          >
                        </div>
                      </div>
                      ...
                      <p class="mb-1 pb-lg-2" style="color: #e0ffff">
                        ...
                        <router-link to="/admin/login" class="button">
                          <span style="color: #e0ffff">Đăng nhập</span>
                        </router-link>
                      </p>
                    </form>
                  </div>
                ...
                <div class="col-md-6 col-lg-6 d-none d-md-block m-auto">
                  <img
                    src="https://st5.depositphotos.com/7636160/66206/i/600/depositphotos_662062916-stock-photo-old-book-stack-desk-public.jpg"
                    alt="login form"
                    class="imageLogin"
                  />
                </div>
